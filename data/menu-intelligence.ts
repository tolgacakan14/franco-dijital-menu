...
export const productKnowledge: Record<string, ProductKnowledge> = {
  ...
  "Roma 66": { description: "Buzla servis edilen canlı mercan-kırmızısı içecek; camın iç yüzündeki kırmızı dokunuş sunumunu ayırır.", profile: "Buzlu · canlı", intensity: 2, pairing: "San Sebastian" },
  ...
  "Metropolitan": { description: "Açık yeşil tonlu, bol buzlu ve yalın sunumlu serin içecek.", profile: "Buzlu · hafif", intensity: 2, pairing: "Franco Snickers" },
  "Narsist": { description: "Koyu yakut kırmızısı, buzlu içecek; uzun bardakta belirgin kırmızı yüzey dokusuyla sunulur.", profile: "Kırmızı · yoğun", intensity: 3, pairing: "Tiramisu" },
