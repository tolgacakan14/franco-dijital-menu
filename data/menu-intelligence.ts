...
export const productKnowledge: Record<string, ProductKnowledge> = {
  ...
  "Portakallı": { description: "Portakalın canlı narenciye aromasıyla ferah, parlak ve dengeli bir gelato.", profile: "Portakal · narenciye", intensity: 3, pairing: "Belçika Çikolatası" },

  "Affogato": { description: "Sıcak espresso ile soğuk gelatonun acı–tatlı ve sıcak–soğuk kontrastı.", profile: "Espresso · kremamsı", intensity: 4, pairing: "Sütlü" },
  ...
  "Ice Caramel Latte": { description: "Espresso, soğuk süt ve karamel ekseninde yuvarlak bir içim.", profile: "Karamel · sütlü", intensity: 3, pairing: "San Sebastian" },
  "Ice Toffee Nut Latte": { description: "Şekerleme ve kuruyemiş çağrışımlarıyla dolgun, serin kahve.", profile: "Toffee · kuruyemiş", intensity: 3, pairing: "Lotus Cup" },
  ...
  "Frappe": { description: "Buzla harmanlanan kahvenin yoğun, serin ve köpüklü yorumu.", profile: "Kahve · buzlu", intensity: 3, pairing: "Lotus Cup" },
  ...
  "Türk Kahvesi": { description: "İnce öğütümün oluşturduğu yoğun gövde ve kalıcı kavruk bitiş.", profile: "Gövdeli · kavruk", intensity: 4, pairing: "San Sebastian" },
  ...
  "Toffienut Latte": { description: "Toffee ve kuruyemiş çağrışımlı, tok ve tatlı sütlü kahve.", profile: "Toffee · kavruk", intensity: 3, pairing: "Lotus Cup" },
  ...
  "Cappuccino": { description: "Espresso, sıcak süt ve köpüğün dengeli, havadar birlikteliği.", profile: "Köpüklü · dengeli", intensity: 3, pairing: "Lotus Cup" },
  ...
  "Lotus Cup": { description: "Karamelize bisküvi ve baharat çağrışımıyla çıtır, yoğun bir tatlı.", profile: "Bisküvi · karamel", intensity: 4, pairing: "Cappuccino" },
  ...
  "Franco Mango": { description: "Mango ve ananasın tropikal tatlılığıyla parlak, meyvemsi ve serinletici.", profile: "Mango · ananas", intensity: 2, pairing: "Antep Fıstığı" },
  "Rooibos Peach": { description: "Beyaz şeftalinin meyvemsi ferahlığı ile rooibosun yumuşak bitkisel gövdesi.", profile: "Beyaz şeftali · rooibos", intensity: 2, pairing: "Çilekli Magnolia" },
  "Roma 66": { description: "Baharat blend ve tarçının sıcak karakterini lime narenciyesiyle dengeleyen canlı yorum.", profile: "Baharat · tarçın", intensity: 2, pairing: "San Sebastian" },
  "Cool lime 2.0": { description: "Altın sarısı buzlu içecek; hafif köpüklü yüzeyi ve kurutulmuş narenciye dilimiyle sunulur.", profile: "Narenciye · serin", intensity: 2, pairing: "Lotus Cup" },
  "Metropolitan": { description: "Salatalık, yeşil elma ve nanenin otsu ferahlıkta buluştuğu hafif ve serin denge.", profile: "Salatalık · nane", intensity: 2, pairing: "Franco Snickers" },
  "Narsist": { description: "Japon limonu, nar ve hibiskusun kırmızı, çiçeksi ve canlı bir ekşilikte buluştuğu serin içecek.", profile: "Nar · hibiskus", intensity: 3, pairing: "Tiramisu" },
  "Fincan Çay": { description: "Daha uzun molalar için sıcak, sade ve aromatik çay sunumu.", profile: "Sade · sıcak", intensity: 2, pairing: "San Sebastian" },
  ...
  "Sıkma Limon Soda": { description: "Taze narenciye asiditesi ve sodanın canlı mineralli ferahlığı.", profile: "Narenciye · ferah", intensity: 2, pairing: "Lotus Cup" },
...
const gelatoProfiles: Record<string, GelatoProfile> = {
  ...
  "Portakallı": { family: "citrus", sweet: 2, acid: 3, rich: 1, role: "canlı portakal ferahlığı" }
};
...
export const journeyChoices: Record<string, string> = {
  ...
  "intense-cold-light": "Ice Americano", "intense-cold-sweet": "Ice Mocha", "intense-cold-balanced": "Affogato",
...
export const dailySelections = {
  ...
  afternoon: [
    { title: "Tatlı bir kontrast", copy: "Kremamsı cheesecake dokusunu Türk kahvesinin kavrukluğu dengeler.", product: "San Sebastian" },
