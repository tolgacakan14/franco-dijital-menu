...
export const productKnowledge: Record<string, ProductKnowledge> = {
  ...
  "Cool lime 2.0": { description: "Altın sarısı buzlu içecek; hafif köpüklü yüzeyi ve kurutulmuş narenciye dilimiyle sunulur.", profile: "Narenciye · serin", intensity: 2, pairing: "Lotus Küre" },
